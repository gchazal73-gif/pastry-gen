...
export const INGREDIENTS_GLACE = {
  ...
  // ── PÂTES DE FRUITS SECS 100 % ───────────────────────────────────────────────
  // msng_g = 0 : les protéines végétales ne contribuent pas au risque de sableux laitier
  pate_noisette_glace: {
    label: 'Pâte de noisette pure 100 %',
    pod: 0, pac: 0,
    mg_g: 61, msng_g: 0, lactose_g: 0, eau_g: 5,
  },
  pate_amande_glace: {
    label: "Pâte d'amande pure 100 %",
    pod: 0, pac: 0,
    mg_g: 50, msng_g: 0, lactose_g: 0, eau_g: 5,
  },
  pate_pistache_glace: {
    label: 'Pâte de pistache pure 100 %',
    pod: 0, pac: 0,
    mg_g: 44, msng_g: 0, lactose_g: 0, eau_g: 4,
  },
  pate_cajou_glace: {
    label: 'Pâte de cajou pure 100 %',
    pod: 0, pac: 0,
    mg_g: 47, msng_g: 0, lactose_g: 0, eau_g: 5,
  },
  pate_pecan_glace: {
    label: 'Pâte de pécan pure 100 %',
    pod: 0, pac: 0,
    mg_g: 72, msng_g: 0, lactose_g: 0, eau_g: 4,
  },
  pate_macadamia_glace: {
    label: 'Pâte de macadamia pure 100 %',
    pod: 0, pac: 0,
    mg_g: 76, msng_g: 0, lactose_g: 0, eau_g: 2,
  },
  pate_sesame_glace: {
    label: 'Pâte de sésame (tahini) 100 %',
    pod: 0, pac: 0,
    mg_g: 53, msng_g: 0, lactose_g: 0, eau_g: 3,
  },
  pate_cacahuete_glace: {
    label: 'Pâte de cacahuète pure 100 %',
    pod: 0, pac: 0,
    mg_g: 50, msng_g: 0, lactose_g: 0, eau_g: 7,
  },

  // ── PRALINÉS 60 % (60 % fruits secs + 40 % saccharose) ───────────────────────
  // pod / pac calculés via le sucre interne : 40 g saccharose / 100 g → pod=40, pac=40
  praline_noisette_glace: {
    label: 'Praliné noisette 60 %',
    pod: 40, pac: 40,
    mg_g: 37, msng_g: 0, lactose_g: 0, eau_g: 3,
    note: '~37 % MG (noisette), ~40 % sucre (pod=40, pac=40), ~3 % eau.',
  },
  praline_amande_glace: {
    label: 'Praliné amande 60 %',
    pod: 40, pac: 40,
    mg_g: 30, msng_g: 0, lactose_g: 0, eau_g: 3,
  },
  praline_pistache_glace: {
    label: 'Praliné pistache 60 %',
    pod: 40, pac: 40,
    mg_g: 26, msng_g: 0, lactose_g: 0, eau_g: 3,
  },
  praline_pecan_glace: {
    label: 'Praliné pécan 60 %',
    pod: 40, pac: 40,
    mg_g: 43, msng_g: 0, lactose_g: 0, eau_g: 2,
  },
  praline_sesame_glace: {
    label: 'Praliné sésame 60 %',
    pod: 40, pac: 40,
    mg_g: 32, msng_g: 0, lactose_g: 0, eau_g: 3,
  },
  gianduja_glace: {
    label: 'Gianduja',
    pod: 22, pac: 22,
    mg_g: 38, msng_g: 3, lactose_g: 2, eau_g: 2,
    note: '~22 % sucre, ~38 % MG, traces de lait — vérifier si version vegan disponible.',
  },
};
