/* =====================================================================
   ...
   Source de données : INGREDIENTS_GLACE (dataKey) › mainIngredient (Supabase) › FALLBACK
   ===================================================================== */
...
const INDICATEURS_GLACE     = ['es', 'mg', 'msng', 'pod', 'pac', 'lactose'];
...
function resolveSource(ligne, mainIngredient) {
  ...
  // Priorité 2 : rôle parfum + mainIngredient Supabase
 ...
 * @param {object|null} mainIngredient — données Supabase de l'ingrédient principal (parfum)
 * @returns {{
...
export function calculerIndicateurs(lignes, mainIngredient = null) {
  let eau = 0, lipides = 0, sucres = 0, fibres = 0, lactose = 0;
  let pod = 0, pac = 0;
